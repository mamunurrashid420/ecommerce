...
class OrderService
{
        ...
        return [
            ...
            'stats' => [
                ...
                'status_breakdown' => [
                    ...
                    'purchase_completed' => $statusCounts['purchase_completed'] ?? 0,
                    'shipped_from_supplier' => $statusCounts['shipped_from_supplier'] ?? 0,
                    'received_in_china_warehouse' => $statusCounts['received_in_china_warehouse'] ?? 0,
                    'on_the_way_to_china_airport' => $statusCounts['on_the_way_to_china_airport'] ?? 0,
                    'received_in_china_airport' => $statusCounts['received_in_china_airport'] ?? 0,
                    'on_the_way_to_bd_airport' => $statusCounts['on_the_way_to_bd_airport'] ?? 0,
                    'received_in_bd_airport' => $statusCounts['received_in_bd_airport'] ?? 0,
                    'on_the_way_to_bd_warehouse' => $statusCounts['on_the_way_to_bd_warehouse'] ?? 0,
                    'received_in_bd_warehouse' => $statusCounts['received_in_bd_warehouse'] ?? 0,
                    'processing_for_delivery' => $statusCounts['processing_for_delivery'] ?? 0,
                    'on_the_way_to_delivery' => $statusCounts['on_the_way_to_delivery'] ?? 0,
                    'delivered' => $statusCounts['delivered'] ?? 0,
                    'completed' => $statusCounts['completed'] ?? 0,
                    'processing_for_refund' => $statusCounts['processing_for_refund'] ?? 0,
    ...
    {
        return [
            'pending' => ['confirm', 'purchasing', 'cancelled'],
            'confirm' => ['purchasing', 'cancelled'],
            ...
            'on_the_way_to_delivery' => ['delivered', 'cancelled'],
            'delivered' => ['completed', 'processing_for_refund'],
            'completed' => ['processing_for_refund'],
            'processing_for_refund' => ['refunded'],
            'refunded' => [],
            'cancelled' => [],
        ];
    }
